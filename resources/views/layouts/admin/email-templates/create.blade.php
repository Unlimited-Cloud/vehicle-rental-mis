            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="email_cc" class="form-control"
                           value="{{ old('email_cc') }}" placeholder="cc@example.com, another@example.com">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select name="email_template_triggered" class="form-control">
                        <option value="1" {{ old('email_template_triggered') == 1 ? 'selected' : '' }}>Yes</option>
                        <option value="0" {{ old('email_template_triggered') == 0 ? 'selected' : '' }}>No</option>
                    </select>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select name="sms_template_triggered" class="form-control">
                        <option value="1" {{ old('sms_template_triggered') == 1 ? 'selected' : '' }}>Yes</option>
                        <option value="0" {{ old('sms_template_triggered') == 0 ? 'selected' : '' }}>No</option>
                    </select>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <select name="notification_template_triggered" class="form-control">
                        <option value="1" {{ old('notification_template_triggered') == 1 ? 'selected' : '' }}>Yes</option>
                        <option value="0" {{ old('notification_template_triggered') == 0 ? 'selected' : '' }}>No</option>
                    </select>
                </div>
            </div>
        </div>
