...
<form action="{{ route('admin.email-logs.store') }}"
      method="POST">
        ...
        <div class="row">
                ...
                <div class="form-group">
                    ...
                    <select name="emailtemplate_id" class="form-control">
                        ...
                        @foreach($emailTemplates as $template)
                            <option value="{{ $template->id }}" {{ old('emailtemplate_id') == $template->id ? 'selected' : '' }}>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea name="email_body" class="form-control" rows="5" required>{{ old('email_body') }}</textarea>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <textarea name="failure_reason" class="form-control" rows="2">{{ old('failure_reason') }}</textarea>
                </div>
            </div>
        </div>
    </div>
